...
class Achievement(common.GameDBBase, common.MaybeEncrypted):
    ...
    default_open_flag: sqlalchemy.orm.Mapped[int | None] = sqlalchemy.orm.mapped_column()
    display_flag: sqlalchemy.orm.Mapped[int | None] = sqlalchemy.orm.mapped_column()
    achievement_filter_category_id: sqlalchemy.orm.Mapped[int | None] = sqlalchemy.orm.mapped_column()
    achievement_filter_type_id: sqlalchemy.orm.Mapped[int | None] = sqlalchemy.orm.mapped_column()
    auto_reward_flag: sqlalchemy.orm.Mapped[int | None] = sqlalchemy.orm.mapped_column()
    display_start_date: sqlalchemy.orm.Mapped[int | None] = sqlalchemy.orm.mapped_column()
